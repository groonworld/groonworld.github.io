...
(function() {  
    ...
    function updateUI() { // Prints all the results to the user interface
        ...
        document.getElementById('cappuchino_price').innerHTML = '<p>Dein geliebter ' + prices.cappuchino + '&euro;-Mandelmilch-Cappuchino kostet dich <span>' + prices.cappuchino + '</span> deiner Arbeitszeit.</p>';
    };
